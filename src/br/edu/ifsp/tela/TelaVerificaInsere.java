...
public class TelaVerificaInsere extends JFrame {

	private JPanel contentPane;
	private JButton btnSim;
	private JButton btnNo;

	public TelaVerificaInsere() {
		...
		JLabel lblNewLabel = new JLabel("Ja existe o livro cadastrado, deseja atualizar a quantidade?");
